...
public class Part2Subtest1 extends Activity {
	...
	final String resource_prefix = "t_2_s_1_";
	Part2Subtest1 entity = null;
	int[] correct_answers = {3, 4, 4, 3, 2, 3, 3, 5, 4, 1, 3, 1};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Intent intent = Part2Subtest1.this.getIntent();
			...
			timer = new CountDownTimer(15000, 1000) {
				...
				public void onFinish() {
				 	...
				 	if (current_question > correct_answers.length) {
						Intent intent = new Intent(Part2Subtest1.this, Part2Subtest2.class);
				 		intent.putExtra("login", login);
						intent.putExtra("part1_score", part1_score);
						intent.putExtra("part2_score", part2_score + current_score);
						Part2Subtest1.this.startActivity(intent);
						finish();
				 	}
