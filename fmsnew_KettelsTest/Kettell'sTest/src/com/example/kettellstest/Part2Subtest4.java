...
public class Part2Subtest4 extends Activity {
	...
	final String resource_prefix = "t_2_s_4_";
	Part2Subtest4 entity = null;
	int[] correct_answers = {3, 4, 2, 3, 1, 1, 2, 2};
	
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_part2_subtest4);
		entity = this;
		final Bundle final_savedInstanceState = savedInstanceState;
		
		Intent intent = Part2Subtest4.this.getIntent();
			...
			timer = new CountDownTimer(15000, 1000) {
				...
				public void onFinish() {
				 	...
				 	if (current_question > correct_answers.length) {
						Intent intent = new Intent(Part2Subtest4.this, FinalizeTesting.class);
				 		intent.putExtra("login", login);
						intent.putExtra("part1_score", part1_score);
						intent.putExtra("part2_score", part2_score + current_score);
						Part2Subtest4.this.startActivity(intent);
						finish();
				 	}
