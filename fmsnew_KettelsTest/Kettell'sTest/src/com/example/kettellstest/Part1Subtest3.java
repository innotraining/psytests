...
public class Part1Subtest3 extends Activity {
	...
	final String resource_prefix = "t_1_s_3_";
	Part1Subtest3 entity = null;
	int[] correct_answers = {3, 2, 1, 5, 4, 1, 3, 2, 5, 1, 2, 2};
	
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_part1_subtest3);
		entity = this;
		final Bundle final_savedInstanceState = savedInstanceState;
		
		Intent intent = Part1Subtest3.this.getIntent();
			...
			timer = new CountDownTimer(15000, 1000) {
				...
				public void onFinish() {
				 	...
				 	if (current_question > correct_answers.length) {
						Intent intent = new Intent(Part1Subtest3.this, Part1Subtest4.class);
				 		intent.putExtra("login", login);
						intent.putExtra("part1_score", part1_score + current_score);
						Part1Subtest3.this.startActivity(intent);
						finish();
				 	}
