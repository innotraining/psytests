...
public class Part2Subtest2 extends Activity {
	...
	final String resource_prefix = "t_2_s_2_";
	Part2Subtest2 entity = null;
	int[] correct_answers = {2, 3, 4, 3, 3, 1, 4, 3, 1, 1, 3, 1, 3, 4};
	
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_part2_subtest2);
		entity = this;
		final Bundle final_savedInstanceState = savedInstanceState;
		
		Intent intent = Part2Subtest2.this.getIntent();
			...
			timer = new CountDownTimer(15000, 1000) {
				...
				public void onFinish() {
				 	...
				 	if (current_question > correct_answers.length) {
						Intent intent = new Intent(Part2Subtest2.this, Part2Subtest3.class);
				 		intent.putExtra("login", login);
						intent.putExtra("part1_score", part1_score);
						intent.putExtra("part2_score", part2_score + current_score);
						Part2Subtest2.this.startActivity(intent);
						finish();
				 	}
