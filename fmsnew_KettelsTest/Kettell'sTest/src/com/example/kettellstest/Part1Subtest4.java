...
public class Part1Subtest4 extends Activity {
	...
	final String resource_prefix = "t_1_s_4_";
	Part1Subtest4 entity = null;
	int[] correct_answers = {2, 4, 2, 3, 1, 1, 3, 2};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Intent intent = Part1Subtest4.this.getIntent();
			...
			timer = new CountDownTimer(15000, 1000) {
				...
				public void onFinish() {
					...
					if (current_question > correct_answers.length) {
						Intent intent = new Intent(Part1Subtest4.this, ShortBreakBetweenParts.class);
				 		intent.putExtra("login", login);
						intent.putExtra("part1_score", part1_score + current_score);
						Part1Subtest4.this.startActivity(intent);
						finish();
					}
