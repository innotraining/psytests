...
public class MMPITest implements PsychologyTextedTest {
	...
	private class MMPIAnswerHandler {
		...
		public MMPIAnswerHandler(String name, String shortName, Resources res,
				int upNumsId, int downNumsId, int descrId) {
			this.name = name;
	...
	private class LieHandler extends MMPIAnswerHandler {
		public LieHandler(Resources res) {
			super(res.getText(R.string.lie_scale).toString(), "L", res, 0,
					R.raw.lie_nums, 0);
		}
	...
	public MMPITest(boolean isMale, Resources res) {
		...
		new MMPIAnswerHandler(res.getText(R.string.reliability).toString(),
				"F", res, R.raw.reliability_up_nums,
				R.raw.reliability_down_nums, R.raw.pessimistically_desc);
		new MMPIAnswerHandler(res.getText(R.string.correction).toString(), "K",
				res, R.raw.correction_up_nums, R.raw.correction_down_nums,
				R.raw.correction_desc);
		new MMPIAnswerHandler(res.getText(R.string.overcontrol).toString(),
				"Hs(1)", res, R.raw.overcontrol_up_nums,
				R.raw.overcontrol_down_nums, R.raw.overcontrol_desc);
		new MMPIAnswerHandler(res.getText(R.string.pessimistic).toString(),
				"D(2)", res, R.raw.pessimistically_up_nums,
				R.raw.pessimistically_down_nums, R.raw.pessimistically_desc);
		new MMPIAnswerHandler(res.getText(R.string.hysteria).toString(),
				"Hy(3)", res, R.raw.hysteria_up_nums, R.raw.hysteria_down_nums,
				R.raw.hysteria_desc);
		new MMPIAnswerHandler(res.getText(R.string.impusivity).toString(),
				"Pd(4)", res, R.raw.impulsiveness_up_nums,
				R.raw.impulsiveness_down_nums, R.raw.impulsiveness_desc);
		if (isMale) {
			new MMPIAnswerHandler(res.getText(R.string.feminity_male)
					.toString(), "Mf(5)", res, R.raw.femininity_up_nums_male,
					R.raw.femininity_down_nums_male, R.raw.femininity_desc_male);
		} else {
			new MMPIAnswerHandler(res.getText(R.string.feminity_female)
					.toString(), "Mf(5)", res, R.raw.femininity_up_nums_female,
					R.raw.femininity_down_nums_female,
					R.raw.femininity_desc_female);
		}
		new MMPIAnswerHandler(res.getText(R.string.stiff).toString(), "Rg(6)",
				res, R.raw.stiff_up_nums, R.raw.stiff_down_nums,
				R.raw.stiff_desc);
		new MMPIAnswerHandler(res.getText(R.string.anxiety).toString(),
				"Pt(7)", res, R.raw.anxiety_up_nums, R.raw.anxiety_down_nums,
				R.raw.anxiety_desc);
		new MMPIAnswerHandler(res.getText(R.string.individual).toString(),
				"Sc(8)", res, R.raw.individualistic_up_nums,
				R.raw.individualistic_down_nums, R.raw.individualistic_desc);
		new MMPIAnswerHandler(res.getText(R.string.optimistic).toString(),
				"Ma(9)", res, R.raw.optimistic_up_nums,
				R.raw.optimistic_down_nums, R.raw.optimistic_desc);
		new MMPIAnswerHandler(res.getText(R.string.introversion).toString(),
				"Si(0)", res, R.raw.introversion_up_nums,
				R.raw.introversion_down_nums, R.raw.introversion_desc);
